...
public class Problema5_Teatro {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (tipo) {
                case 1:
                    nuevaEntrada = new EntradaNormal(siguienteId, nombreComprador, zonaElegida);
                    break;
                case 2:
                    nuevaEntrada = new EntradaReducida(siguienteId, nombreComprador, zonaElegida);
                    break;
                case 3:
                    nuevaEntrada = new EntradaAbonado(siguienteId, nombreComprador, zonaElegida);
                    break;
                default:
            ...
            String deseaConsultar = entrada.nextLine();
            if (deseaConsultar.equals("S") || deseaConsultar.equals("s")) {
            ...
            seguirVendiendo = entrada.nextLine();
        } while (seguirVendiendo.equals("S") || seguirVendiendo.equals("s"));
        System.out.println("\n--- Entradas vendidas ---");
        for (Entrada e : entradasGeneradas) {
            System.out.println(e);
        }
